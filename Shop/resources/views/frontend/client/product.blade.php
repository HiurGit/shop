                                ...
                                <div class="contain-product layout-02">
                                    <div class="product-thumb">
                                        <a href="#" class="link-to-product">
                                            <img src="{{ asset('public/frontend')}}/assets/images/products/p-08.jpg" alt="dd" width="160" height="160" class="product-thumnail">
                                        </a>
                                    </div>
                                    <div class="info">
                          ...
                          <li class="product-item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                    <div class="contain-product layout-default">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="product-title"><a href="#" class="pr-name">{{ Str::limit($item->name, 25)}}</a></h4>
                                            <div class="price">
